        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    <span class="sr-only">FVSP Terre-Sainte 2026</span>
                    <img class="h-32 w-auto" src="{{ asset('images/logo.png') }}" alt="">
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="/admin" class="text-sm/6 font-semibold text-gray-900">Login <span aria-hidden="true">&rarr;</span></a>
            </div>
        </nav>
            ...
            <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div class="py-6">
                            <a href="/admin" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Login</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-gray-900">
        <div class="mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-16 lg:px-8">
            ...
            <div class="mt-16 flex justify-center gap-x-10">
                <a href="https://www.instagram.com/sdis_terre_sainte/" class="text-gray-400 hover:text-gray-300">
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-400">&copy; {{ date('Y') }} SDIS Terre-Sainte.</p>
        </div>
    </footer>
