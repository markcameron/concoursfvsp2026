            ...
            <div class="mb-10 flex flex-col gap-x-8 gap-y-8 md:flex-row lg:gap-x-14">
                ...
                <div class="w-max flex-1 shrink-0 space-y-5">
                    <div class="flex items-center gap-x-3 gap-y-0.5 max-lg:flex-wrap md:justify-end">
                        <span class="font-display text-theme-red font-medium uppercase">FVSP Terre-Sainte 2026</span>
                        <div class="flex items-center gap-x-2">
                            <a href="https://www.fvsp-terre-sainte-2026.ch/" target="_blank" aria-title="Voir le site du FVSP Terre-Sainte 2026">
                            ...
                            <a href="https://www.instagram.com/fvspterresainte2026" target="_blank" class="" aria-label="Voir la page instagram du SDIS Terre-Sainte">
                                <svg width="22" height="22" fill="#1246A1">
                                    <path
