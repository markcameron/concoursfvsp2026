        ...
        <div class="">
            <div class="mx-auto max-w-7xl lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-10 flex items-center gap-x-6 lg:mt-0 lg:shrink-0">
                    <a href="{{ $block->url }}" class="shadow-xs bg-theme-blue rounded-md px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-blue-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">
                        {{ $block->button_text }}
                    </a>
                </div>
            </div>
